...
namespace WGTRework
{
    public partial class WGTPlayerController : NetworkBehaviour
    {
        ...
        //[SyncVar(hook = nameof(OnPlayerIsChargingWater))] private bool isCurrentlyChargingWater;
        //[SyncVar(hook = nameof(OnPlayerIsAbleToChargeWater))] private bool isAbleToChargeWater;
